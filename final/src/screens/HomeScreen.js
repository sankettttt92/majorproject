...
//below it correct homescreen code 
// import React, { useEffect, useState, useCallback } from 'react';
// import {
//   View, Text, ScrollView, TouchableOpacity,
//   StyleSheet, Alert, RefreshControl,
...
import StatusBarWidget from '@/components/StatusBarWidget';
import SOSCountdown from '@/components/SOSCountdown';
import SOSLoadingScreen from '@/components/SOSLoadingScreen';
import { formatTime, formatDate } from '@/utils/time';
...
export default function HomeScreen({ navigation }) {
  ...
  // ── Radar / status screen shown after SOS is sent ──
  ...
  const handleSOS = async () => {
    ...
    // Instead of a native alert, hand off to the radar/status screen.
  ...
  // ── While an SOS is active, show the radar/status screen instead of Home ──
  if (showSOSScreen) {
    return (
      <SOSLoadingScreen incidentStatus={incidentStatus} />
    );
  }
