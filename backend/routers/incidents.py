...
# from models.incident import Incident, IncidentStatus
# from schemas.incident_out import IncidentOut
# from socket_manager import emit_status_update_to_user
...
#     # Notify the victim's phone directly, if it's connected and has joined its room
#     if incident.user_id:
#         await emit_status_update_to_user(str(incident.user_id), {
#             "incident_id": str(incident.id),
#             "status": incident.status.value,
#             "message": f"Your incident status is now {incident.status.value}",
#         })
...
async def update_incident_status(
    ...
    # Notify the victim's phone directly, if it's connected and has joined its room
    print("Incident user_id:", incident.user_id)
    if incident.user_id:
        print("Sending socket update to:", incident.user_id)
        await emit_status_update_to_user(
