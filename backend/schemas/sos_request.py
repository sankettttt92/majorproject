...
class SOSRequest(BaseModel):
    # Client-generated incident UUID
    incident_id: UUID = Field(
        ...,
        description="Client-generated incident ID"
    )

    # UUID from registered_users.id
    user_id: UUID = Field(
        ...,
    ...
    device_id: Optional[str] = Field(
        None,
        description="Device fingerprint / install ID"
    )

    auth_token: str = Field(
        ...,
        description="Token issued during registration/login"
    )
    ...
    detail: Optional[str] = Field(
        None,
        description="Free text from the victim"
    )
