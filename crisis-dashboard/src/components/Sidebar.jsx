...
import {
  ShieldCheck, LayoutGrid, AlertTriangle, Truck, Activity,
  Route as RouteIcon, Bot, Smartphone, Circle, MapPinned // Added MapPinned icon for the new feature
} from "lucide-react";
...
const opsItems = [
  ...
  { to: "/route-optimization", label: "Route Optimization", icon: RouteIcon, disabled: true },
  { to: "/ai-agents", label: "AI Agents", icon: Bot, disabled: true },
  // ── Brand New Feature Added Here ─────────────────────────────────────────
  { to: "/live-tracking", label: "Live Incident Tracker", icon: MapPinned },
];
